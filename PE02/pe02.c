...
int main(int argc, char * * argv)
{
   ...
   if(argv[1][1] == 'm')
   {
    integral = mid_point_numerical_integration(lower_limit,upper_limit,intervals);
   }
   else if(argv[1][1] == 't')
   {
    integral =trapezoidal_numerical_integration(lower_limit, upper_limit, intervals);
   }
   else
   {
    return EXIT_SUCCESS;
