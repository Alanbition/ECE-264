...
void test_00_largest_partial_sum()
{
 ...
 //   test_largest_partial_sum(array2, len2, 0);
    ...
    // ...
    int array5[] = { 0, 1, 5, -4, 5};
	int len5 = 5;
	test_largest_partial_sum(array5, len5, 7);
...
void test_largest_difference(int * array, int len, int expected)
{
	...
	printf(". largest difference = %d, expected = %d.", Diff, expected);
	if(Diff != expected)
	printf(" FAIL");
	printf("\n");
}
void test_01_largest_difference()
{
	...
	int len1 = 5;
	test_largest_difference(array1, len1, 9);

    int array2[] = { -4,1, 5,7,-12 ,5, 8};
	int len2 = 7;
	test_largest_difference(array2, len2, 20);

//	int array3[] = {};
//	int len3 = 0;
//	test_largest_difference(array3, len3, 0);

	int array4[] = {-1, -2, -3, -4};
	int len4 = 4;
	test_largest_difference(array4, len4, 3);
    
	int array5[] = {142, 44, 333, 246, -10, -204, 190};
	int len5 = 7;
	test_largest_difference(array5, len5, 537);
...
int main(int argc, char * * argv)
{
    ...
    int argvnew = strtol(argv[1], NULL, 10);
	if(argv[1][1] != 'NULL')
	{
	}
    if(argvnew == 1)
